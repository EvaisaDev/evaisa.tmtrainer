...
local function generate_image(index, original_sprite, was_first)
	local corrupted_sprite = "mods/evaisa.tmtrainer/files/spell_icons/" .. index .. ".png"
...
local global_seed = ModSettingGet("evaisa.tmtrainer.global_seed") or world_seed
ModSettingSet("evaisa.tmtrainer.global_seed", global_seed)
SetWorldSeed(global_seed)
print("Generating TMTRAINER")
...
local function create_tmtrainer_action(action_type, index)
	...
	local sprite = "mods/evaisa.tmtrainer/files/spell_icons/" .. index .. ".png"
	...
	local function action_function(recursion_level, iteration)
		...
		-- Add extra entities
		c.extra_entities = c.extra_entities .. "mods/evaisa.tmtrainer/files/entities/spawn.xml,"
